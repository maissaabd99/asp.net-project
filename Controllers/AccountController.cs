...
namespace testest.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
           ...
           // Console.WriteLine("result de login :",result);
            switch (result)
            {
                case SignInStatus.Success:
                    var user = await UserManager.FindAsync(model.Email, model.Password);
                    var roles = await UserManager.GetRolesAsync(user.Id);
                    //var x = System.Web.HttpContext.Current.User.Identity.GetUserId();
                    System.Diagnostics.Debug.WriteLine("User check !!!!!!!!!!!!!!!!!!!! :"+ user.Email);
                    ...
                    else 
                    {
                        if (roles.Contains("User"))
                            return RedirectToAction("MesTestsQCM","Candidat");
                        else
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Console.WriteLine(user.DateNaissance);
